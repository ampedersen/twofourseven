...
//        cleanup();
    ...
    public void setAction(final String url, String title, String description, String programTitle, String topic, int newAction) {
    ...
    public void onAudioFocusChange(int focusChange) {
        switch (focusChange) {
            case AudioManager.AUDIOFOCUS_GAIN:
                ...
                // Resume playback
                if (action == RadioPlayer.ACTION_PAUSE) {
                    setAction(url, title, description, programTitle, topic, RadioPlayer.ACTION_PLAY);
                }
                if (player != null) {
            ...
            case AudioManager.AUDIOFOCUS_LOSS:
                ...
                if (action == RadioPlayer.ACTION_PLAY) {
                    setAction(url, title, description, programTitle, topic, RadioPlayer.ACTION_PAUSE);
                } else {
                    setAction(url, title, description, programTitle, topic, RadioPlayer.ACTION_STOP);
                }
                break;
